...
|---|---|---|
| 1     | `how-to-read-a-wireshark-TCP-HTTP-log.md` | Guia de referência para interpretar os campos e padrões de um log do Wireshark capturando tráfego TCP/HTTP — necessário antes de examinar o log real. |
| 2 | `wireshark-TCP-HTTP-log.md` | A evidência bruta: o log de pacotes capturado durante o incidente, mostrando o volume anômalo de requisições SYN. |
